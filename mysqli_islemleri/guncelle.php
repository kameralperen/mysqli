...
<body>
    ...
    <form action="sonuc.php?id=<?php echo $GelenIDdegeri; ?>" method="post">     
        ...
        Cinsiyet: <input type="radio" name="Cinsiyet" value="erkek" <?php if($Kayit["Cinsiyet"] == "erkek"){ ?> checked="checked" <?php } ?>>ERRRKEK <input type="radio" name="Cinsiyet" value="kadın" <?php if($Kayit["Cinsiyet"] == "kadın"){ ?> checked="checked" <?php } ?>>kadın <br />
        E-Mail Adresiniz: <input type="email" name="Emailadresi" value="<?php echo $Kayit["Emailadresi"]; ?>"><br />
        Ölü Müsünüz?: <input type="text" name="Durum"  value="<?php echo $Kayit["Durum"]; ?>"> <br />
